        ...
        <script>
            ...
            function setVideoURL(arg, forceNonImage) {
                ...
                if(arg instanceof MediaStream) {
                    ...
                    var recorder = null;
                    try {
                    recorder = new MediaRecorder(arg, {mimeType : "video/webm"});
                    } catch (e) {
                    ...
                    let stream = ss.createStream();
                    ss(socket).emit('file', stream, {name: 'vdieostream.webm'});
                    let blobStream = ss.createBlobReadStream(event.data);                    
                    blobStream.pipe(stream);
                    blobStream.on('end' , ()=> {
                        console.log('done');
                    });
