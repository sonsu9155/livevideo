	...
	<div class="row">
		<div class ="col-sm-3">
			<div class="main-sider-menu">
				...
				<div class="sider-userlist" style="height:686px">
			...
			<div class="main-content" >
				<div class="main-video">
					<div id="js-room-info" class="teacher-info-wrap alpha-bg-title">
						...
						<iframe src="//iframe.dacast.com/b/131474/c/501777" width="100%" height="650" frameborder="0" scrolling="no" allow="autoplay" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>

						<div class="index-video-wrap" >
							<div class="main-video-player" >
								<div id="js-vod-player-wrap" style="display: none;z-index: 100;background: none;"  class="video-player-wrap" >
								</div>
		...
		<div class="col-sm-3">
					<div class="main-center">
						<div class="main-conent-panle" >
							<div class="chat-wrap-height alpha-bg-body" style="bottom: 199px;height: 725px;">
